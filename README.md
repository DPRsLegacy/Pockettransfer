...
2. **Nginx Proxy Manager** terminates HTTPS for **`https://your-website.com`** and proxies to the LXC.

| Component | Guide |
|-----------|--------|
| Docker LXC deploy | [deploy/proxmox/README.md](deploy/proxmox/README.md) |
| NPM + `your-website.com` | **[deploy/nginx-proxy-manager.md](deploy/nginx-proxy-manager.md)** |
...
Health (on LXC): `curl http://127.0.0.1:8080/health`
...
Open your NPM URL in a browser on PC or phone:
...
CFW required. First launch: create an account or log in with the console keyboard — the app stores the device token itself.
